...
import PinCodeFetchAdmin from './PinCodeFetchAdmin';

const PinCodeMainAdmin = () => {
  ...
  return (
    <div className='pin-input-parent'>
      ...
      <h2>To Add a New Warehouse enter the Pincode:</h2>
        <input
          type="text"
          id="pincode"
          name="pincode"
      ...
      {pincode.length === 6 && (
          <PinCodeFetchAdmin pincode={pincode} />
...
export default PinCodeMainAdmin;